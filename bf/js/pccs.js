        ...
        if (v && document.getElementById(s[v - 1]).selectedIndex > 0 || !v) {
            if (dsy.Exists(str)) {
                ...
                for (i = 0; i < ar.length; i++){
                    ...
                    if(json){
                        if(ar[i]==json.province && !v){
                            options.selectedIndex=i+1;
                        }else if(ar[i]==json.city && v==1){
                            options.selectedIndex=i+1;
                        }else if(ar[i]==json.county && v==2){
                            options.selectedIndex=i+1;
                        }
                    }
                }
...
dsy.add("0_24_2", ["青羊区", "崇州市", "大邑县", "都江堰市", "金堂县", "彭州市", "蒲江县", "双流县", "新津县", "邛崃市", "郫县","武侯区","金牛区","成华区","锦江区"]);
