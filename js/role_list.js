            ...
            success:function(data){
                ...
                $.each(data.data,function(data,val){
                    ...
                    str+="<li>" +
                        ...
                        "<a href='role_list_privilege.html?id="+val.id+"'><button class='jurisdiction role_list_privilege' flog="+val.id+">权限配置</button></a>"+
                        "</span>" +
                        "</li>";
                    strhead="<li class='li admin_listcontent_mean'><span class='add_role_list_number'>编号</span><span class='add_role_list_role_name'>角色名称</span> " +
                ...
                $("li:even").css("background-color","#F2F2F3");
                //权限状态
