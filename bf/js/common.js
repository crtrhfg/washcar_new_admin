...
//	$(".content").css({"height":$(window).height()-$(".header").height()-17,"max-width":$(window).width()+15});
//	$(".content_left_list").css("height",(($(window).height()-$(".header").height()-$(".bannerfoot").height()-$(".content_left_mean").height())/11)-20);
//	$(".header_rigt").css("width",($(window).width()-$(".header_left").width())/3);
	$(".bannerfoot").css("width",$(".content").width()-$(".content_right").width());
	$.ajax({
		type:"get",
