        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data.data,function(data,val){
                    id++;
                    str+="<tr><td>"+val.seid+"</td><td>"+val.phonenum+"</td><td>"+val.name+"</td><td>"+val.building+"</td>" +
                        "<td><a href='admin_add.html?seid="+val.seid+"'><button class='send' id='send'>订购</button></a><button class='remove' flog="+val.seid+">删除</button>"+
                        "</td></tr>";
                    strhead="<tr><td>序号</td><td>手机号</td><td>姓名</td><td>楼盘</td><td>操作</td></tr>";
                });
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data.status==1){
                            ...
                            $.each(data.data,function(data,val){
                                id++;
                                str+="<tr><td>"+val.seid+"</td><td class='phone'>"+val.phonenum+"</td><td>"+val.name+"</td>"+
