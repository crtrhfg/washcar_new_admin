$(function(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data.data,function(data,val){
                    str+="<tr>" +
                        "<td class='province'>"+val.province+"</td><td class='city'>"+val.city+"</td><td class='county'>"+val.county+"</td><td class='building'>"+val.building+"</td><td class='wname'>"+val.wname+"</td>" +
                        "<td class='housemanage_button'>" +
                        "<div><button class='remove' flog="+val.vid+">删除</button>" +
                        "<a href='house_manage_change.html?vid="+val.vid+"'><button class='change_house'>修改</button></a></div></td>"+
                        "</tr>";
                        ...
                        $.ajax({
                            ...
                            success:function(data){
                                if (data.status==1) {
                                        ...
                                        $.each(data.data,function(data,val){
                                            str+="<tr>" +
                                                "<td>"+val.province+"</td><td>"+val.city+"</td><td>"+val.county+"</td><td class='building'>"+val.building+"</td><td>"+val.wname+"</td>" +
                                                "<td class='housemanage_button'>" +
                                                "<div><button class='remove' flog="+val.vid+">删除</button>" +
                                                "<button class='change_house'>修改</button></div></td>"+
                                                "</tr>";
                                            strhead="<tr><td>省市</td><td>城市</td><td>县区</td><td>楼盘</td><td>负责人</td><td>操作</td>"+
                                                " </tr>"
                                        });
    ...
    $(".house_save").click(function () {
        ...
        //var wids=$(".selected_principal select option").attr("flog");
        var wids=floga;
