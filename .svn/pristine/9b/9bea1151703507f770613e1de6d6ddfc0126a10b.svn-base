                ...
                $.each(data.data,function(data,val){
                    ...
                    if(val.luck==1){
                       str+=("<tr>" +
                            ...
                            "<td class='admin_ip'>"+val.recip+"</td>" +
                            "<td class='register_time'>"+val.rectime+"</td>" +
...
// "+statues[val.luck?0:1]+"
                    ...
                    strhead="<tr><td class='admin_list_id'>编号</td>"+
    ...
    $(".administratorlist_add_bcbutton>button").click(function () {
        ...
        if(name!=""&&user!=""&&pass!=""){
            $.ajax({
                ...
                success:function(data){
                    //console.log(name+"/"+user+"/"+pass+"/"+aid);
                    if(data.status==1){
                        alert(data.msg);
